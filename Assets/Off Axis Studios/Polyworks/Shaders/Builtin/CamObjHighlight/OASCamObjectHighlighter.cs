...
#if UNITY_ANDROID
        var blurred = RenderTexture.GetTemporary(_rtWidth, _rtHeight, 0, RenderTextureFormat.ARGB32 );
#else
			...
			{
#if UNITY_ANDROID
            var occluded = RenderTexture.GetTemporary(_rtWidth, _rtHeight, 0, RenderTextureFormat.ARGB32 );
#else
